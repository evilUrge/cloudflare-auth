    ...
    <div className="min-h-screen flex bg-page">
      ...
      <aside className="w-64 bg-page border-r border-border text-text-primary flex flex-col">
        <div className="p-6 flex flex-col items-center text-center">
          <img src="/logo.png" alt="Auth Service" className="h-16 w-auto rounded-lg dark:hidden" />
          <img src="/logo_dark.png" alt="Auth Service" className="h-16 w-auto rounded-lg hidden dark:block" />
        </div>
